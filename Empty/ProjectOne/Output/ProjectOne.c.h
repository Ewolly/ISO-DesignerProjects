...
#define MaskOne_Offset                                         21
#define Line_13000_Offset                                      29
#define LineAttributes_24000_Offset                            40

#define ISO_OP_MEMORY_CLASS

#define ISO_OP_ProjectOne_Size     48
extern const unsigned char ISO_OP_MEMORY_CLASS isoOP_ProjectOne[];

#define ISO_OP_ProjectOne_ObjectNumber      4
extern const unsigned long ISO_OP_MEMORY_CLASS isoOP_ProjectOne_Offset[];
extern const unsigned long ISO_OP_MEMORY_CLASS isoOP_ProjectOne_Offset_Id[];
#define ISO_OP_ProjectOne_Scale_Offset      1
